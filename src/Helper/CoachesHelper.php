...
class CoachesHelper extends PeopleHelper implements PeopleInterface
{
	...
	public function getPeople(Registry $params, SiteApplication $app): array
	{
		...
		$model = $app->bootComponent('com_footballmanager')->getMVCFactory()->createModel('Coaches', 'Site', ['ignore_request' => true]);
